...
{
	{
		...
		cout << "TYPE_MAX_SIZE: " << TYPE_MAX_SIZE << endl;
		cout << "MIN_STD_POWER: " << MIN_STD_POWER << endl;
		cout << "MAX_STD_POWER: " << MAX_STD_POWER << endl;
		cout << endl;
	}
